...
export default function RegisterPage() {
  ...
  // Auto-generate slug from name
    ...
    <main className="min-h-screen flex items-center justify-center px-4 py-10" style={{ background: '#fdf2f7' }}>
        <div className="w-full max-w-lg bg-white rounded-2xl p-8" style={{ border: '0.5px solid #f5d5e8' }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <input
                ...
                placeholder="Rua das Oliveiras 65, Leiria"
                required
                className="w-full rounded-xl px-3 py-2.5 text-sm outline-none"
                style={{ border: '1px solid #f5d5e8' }}
            />
